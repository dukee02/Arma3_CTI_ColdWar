...
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\units\unitsbase\ubase_BW_BWadd.sqf", format["setting up factory units for side %1", _side]] call CTI_CO_FNC_Log;};
