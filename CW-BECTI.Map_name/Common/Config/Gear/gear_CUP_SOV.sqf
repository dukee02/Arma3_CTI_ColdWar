...
_u pushBack (_tech_level*_tech_level_no_upgrade_inv);
_p pushBack round ((45*556*45)/100000)*((CTI_ECONOMY_PRIZE_WEAPONS*(_tech_level+1)*CTI_ECONOMY_LEVEL_MULTI)/10000);
...
_u pushBack (_tech_level*_tech_level_no_upgrade_inv);
_p pushBack round ((150*762*54)/100000)*((CTI_ECONOMY_PRIZE_WEAPONS*(_tech_level+1)*CTI_ECONOMY_LEVEL_MULTI)/10000);
