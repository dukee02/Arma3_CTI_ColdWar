...
if(_tag == "GUER_") then {
	switch(CTI_TOWN_CAMO) do {
		case 1: {//winter camo active
			missionNamespace setVariable [format["CTI_%1Soldier", _tag], format["%1gm_gc_army_rifleman_mpiak74n_80_win", _sid]];
		};
	...
	missionNamespace setVariable [format["CTI_%1Pilot", _tag], format["%1gm_gc_airforce_pilot_pm_80_blu", _sid]];
};
