...
if (CTI_Log_Level >= CTI_Log_Debug) then {
	["VIOC_DEBUG", "FILE: common\config\Towns_other_mods.sqf", format["Town Squad preparation - sid: <%1> tag: <%2> ", _sid, _tag]] call CTI_CO_FNC_Log;
};
...
if (CTI_Log_Level >= CTI_Log_Debug) then {
	["VIOC_DEBUG", "FILE: common\config\Towns_other_mods.sqf", format["Town Squad <%1> with units <%2> ", format["%1INFANTRY_SQ_LIGHT", _tag], missionNamespace getVariable format["%1INFANTRY_SQ_LIGHT", _tag]]] call CTI_CO_FNC_Log;
	["VIOC_DEBUG", "FILE: common\config\Towns_other_mods.sqf", format["Town Squad <%1> with units <%2> ", format["%1INFANTRY_SQ_MG", _tag], missionNamespace getVariable format["%1INFANTRY_SQ_MG", _tag]]] call CTI_CO_FNC_Log;
	["VIOC_DEBUG", "FILE: common\config\Towns_other_mods.sqf", format["Town Squad <%1> with units <%2> ", format["%1INFANTRY_SQ_AT", _tag], missionNamespace getVariable format["%1INFANTRY_SQ_AT", _tag]]] call CTI_CO_FNC_Log;
};
*/
//***************************************************************************************************************************************
//														Town Wheeled setup																*
...
if (CTI_Log_Level >= CTI_Log_Debug) then {
	["VIOC_DEBUG", "FILE: common\config\Towns_other_mods.sqf", format["Town Squad <%1> with units <%2> ", format["%1WHEELED_SQ_LIGHT", _tag], missionNamespace getVariable format["%1WHEELED_SQ_LIGHT", _tag]]] call CTI_CO_FNC_Log;
	["VIOC_DEBUG", "FILE: common\config\Towns_other_mods.sqf", format["Town Squad <%1> with units <%2> ", format["%1WHEELED_SQ_HEAVY", _tag], missionNamespace getVariable format["%1WHEELED_SQ_HEAVY", _tag]]] call CTI_CO_FNC_Log;
};
*/
//***************************************************************************************************************************************
//														Town Tracked setup																*
...
if (CTI_Log_Level >= CTI_Log_Debug) then {
	["VIOC_DEBUG", "FILE: common\config\Towns_other_mods.sqf", format["Town Squad <%1> with units <%2> ", format["%1TRACKED_SQ_LIGHT", _tag], missionNamespace getVariable format["%1TRACKED_SQ_LIGHT", _tag]]] call CTI_CO_FNC_Log;
	["VIOC_DEBUG", "FILE: common\config\Towns_other_mods.sqf", format["Town Squad <%1> with units <%2> ", format["%1TRACKED_SQ_MEDIUM", _tag], missionNamespace getVariable format["%1TRACKED_SQ_MEDIUM", _tag]]] call CTI_CO_FNC_Log;
	["VIOC_DEBUG", "FILE: common\config\Towns_other_mods.sqf", format["Town Squad <%1> with units <%2> ", format["%1TRACKED_SQ_HEAVY", _tag], missionNamespace getVariable format["%1TRACKED_SQ_HEAVY", _tag]]] call CTI_CO_FNC_Log;
};
*/
...
if(CTI_BW_SIDE == _sideID) then {
	if(CTI_ECONOMY_LEVEL_AIR >= 3) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> "Tornado_AWS_GER")) then {
			...
			AIR_BOMBER append [[format["%1Tornado_AWS_ecr_ger", _sid],1]];			//Suppression of Enemy Air Defenses (SEAD)
			AIR_BOMBER append [[format["%1Tornado_AWS_GER", _sid],1]];
			AIR_BOMBER append [[format["%1Tornado_AWS_camo_ger", _sid],1]];
		};
	};
	if(CTI_ECONOMY_LEVEL_AIR >= 4) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> "EAWS_EF2000_GER_CAP")) then {
			AIR_FIGHTER append [[format["%1EAWS_EF2000_GER_CAP", _sid],1]];	
		};
		...
		if (isClass(configFile >> "CfgVehicles" >> "FIR_F35B_MFG1")) then {
			AIR_FIGHTER append [[format["%1FIR_F35B_MFG1", _sid],1]];
			AIR_FIGHTER append [[format["%1FIR_F35B_MFG2", _sid],1]];
		};
	};	
};
...
if(CTI_BAF_SIDE == _sideID) then {
	if(CTI_ECONOMY_LEVEL_AIR >= 2) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> "FIR_AV8B_GR9A_2")) then {
			AIR_BOMBER append [[format["%1FIR_AV8B_GR7A_Lucy", _sid],1]];
			AIR_BOMBER append [[format["%1FIR_AV8B_GR9A_2", _sid],1]];
		};
	};
	if(CTI_ECONOMY_LEVEL_AIR >= 3) then {
		//Panavia Tornado AWS and variants							1980						Jagdbomber
		if (isClass(configFile >> "CfgVehicles" >> "Tornado_AWS_UK_DS")) then {
			AIR_BOMBER append [[format["%1Tornado_AWS_ADV_uk", _sid],1]];
			AIR_BOMBER append [[format["%1Tornado_AWS_UK_DS", _sid],1]];
			AIR_BOMBER append [[format["%1Tornado_AWS_UK_617", _sid],1]];
			AIR_BOMBER append [[format["%1Tornado_AWS_camo_uk", _sid],1]];
		};
		//F/A-18 Hornet												7. Januar 1983				Mehrzweckkampfflugzeug
		if (isClass(configFile >> "CfgVehicles" >> "FIR_F18C_RCAF")) then {
			///BAF
			AIR_FIGHTER append [[format["%1FIR_F18C_RCAF", _sid],1]];	
			AIR_FIGHTER append [[format["%1FIR_F18C_RAAF", _sid],1]];	
		};
	};
	if(CTI_ECONOMY_LEVEL_AIR >= 4) then {
		//Eurofighter Typhoon AWS										Juli 2006					Mehrzweckkampfflugzeug
		if (isClass(configFile >> "CfgVehicles" >> "EAWS_EF2000_UK_CAP")) then {	
			AIR_FIGHTER append [[format["%1EAWS_EF2000_rafhist_CAP", _sid],1]];	
			AIR_FIGHTER append [[format["%1EAWS_EF2000_UK_CAP", _sid],1]];		
		};
		//EA-18G Growler												22. September 2009			EloKa-Kampfflugzeug
		if (isClass(configFile >> "CfgVehicles" >> "EA18G_RAAF") && CTI_US_CUP_SIDE != _sideID) then {
			AIR_BOMBER append [[format["%1EA18G_RAAF", _sid],1]];
		};
		//Project Lightning - F-35B Armaverse Version					31. Juli 2015				Mehrzweckkampfflugzeug
		if (isClass(configFile >> "CfgVehicles" >> "FIR_F35B_RAF01")) then {
			AIR_FIGHTER append [[format["%1FIR_F35B_RAF01", _sid],1]];	
			AIR_FIGHTER append [[format["%1FIR_F35B_RAF02", _sid],1]];	
		};
	};
};
...
if(CTI_US_CUP_SIDE == _sideID) then {
	if(CTI_ECONOMY_LEVEL_AIR >= 2) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> "FIR_AV8B_VMA223")) then {
			if(CTI_AIR_ADDON >= 0) then {
				AIR_BOMBER append [[format["%1FIR_AV8B_VMA223", _sid],1]];
				//_c pushBack format["%1FIR_AV8B_NA_VMA211", _sid];	
			};
			if(CTI_AIR_ADDON >= 1) then {
				AIR_BOMBER append [[format["%1FIR_AV8B_VMA311", _sid],1]];
			...
			if(CTI_AIR_ADDON >= 2) then {
				AIR_BOMBER append [[format["%1FIR_AV8B_VMA214_22", _sid],1]];
		...
		if (isClass(configFile >> "CfgVehicles" >> "FIR_F14A_Iceman")) then {
			if(CTI_AIR_ADDON >= 0) then {
				AIR_FIGHTER append [[format["%1FIR_F14A_Iceman", _sid],1]];	
				//skin pack 1
			...
			if(CTI_AIR_ADDON >= 1) then {
				AIR_FIGHTER append [[format["%1FIR_F14A_HBK1", _sid],1]];	
			...
			if(CTI_AIR_ADDON >= 2) then {
				AIR_FIGHTER append [[format["%1FIR_F14A_VF201_HIVIZ", _sid],1]];
				//skin pack 2
		...
		if (isClass(configFile >> "CfgVehicles" >> "FIR_F15A_BT")) then {
			if(CTI_AIR_ADDON >= 0) then {
				AIR_FIGHTER append [[format["%1FIR_F15A_BT", _sid],1]];
			...
			if(CTI_AIR_ADDON >= 1) then {	
				AIR_FIGHTER append [[format["%1FIR_F15A_318FIS_1", _sid],1]];
			...
			if(CTI_AIR_ADDON >= 2) then {	
				AIR_FIGHTER append [[format["%1FIR_F15A_5FIS", _sid],1]];
		...
		if (isClass(configFile >> "CfgVehicles" >> "FIR_A10A_MD")) then {
			if(CTI_AIR_ADDON >= 0) then {	
				//skinpack 3
				AIR_BOMBER append [[format["%1FIR_A10C_MD", _sid],1]];
			...
			if(CTI_AIR_ADDON >= 1) then {	
				//skinpack 2
				AIR_BOMBER append [[format["%1FIR_A10A_MD", _sid],1]];//white
			...
			if(CTI_AIR_ADDON >= 2) then {
				//skinpack 1 camo	
				AIR_BOMBER append [[format["%1FIR_A10A_Fulda_SB_608", _sid],1]];
		...
		if (isClass(configFile >> "CfgVehicles" >> "FIR_F16C_930550_sqd")) then {
			if(CTI_AIR_ADDON >= 0) then {
				//55th USAF
				AIR_FIGHTER append [[format["%1FIR_F16C_900830", _sid],1]];
			...
			if(CTI_AIR_ADDON >= 1) then {
				//camo pack 4
				AIR_FIGHTER append [[format["%1FIR_F16C_AS_2", _sid],1]];
			...
			if(CTI_AIR_ADDON >= 2) then {
				//77th USAF
				AIR_FIGHTER append [[format["%1FIR_F16C_000225", _sid],1]];
	...
	if(CTI_ECONOMY_LEVEL_AIR >= 3) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> "FIR_F18C_VMFA251CAG")) then {
			if(CTI_AIR_ADDON >= 0) then {
				AIR_FIGHTER append [[format["%1FIR_F18C_VMFA251", _sid],1]];	
				/*_c pushBack format["%1FIR_F18C_VMFA251CAG", _sid];	
				_c pushBack format["%1FIR_F18D_VMFAAW533", _sid];*/
			};
			if(CTI_AIR_ADDON >= 1) then {
				AIR_FIGHTER append [[format["%1FIR_F18D_VMF224", _sid],1]];
			...
			if(CTI_AIR_ADDON >= 2) then {
				AIR_FIGHTER append [[format["%1FIR_F18C_MALS11", _sid],1]];
	...
	if(CTI_ECONOMY_LEVEL_AIR >= 4) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> "FIR_F22_Blue")) then {
			AIR_FIGHTER append [[format["%1FIR_F22_FF", _sid],1]];
		...
		if (isClass(configFile >> "CfgVehicles" >> "FIR_EA18G_390ECS")) then {
			if(CTI_AIR_ADDON >= 0) then {
				AIR_BOMBER append [[format["%1FIR_EA18G_VAQ138", _sid],1]];
			...
			if(CTI_AIR_ADDON >= 1) then {
				AIR_BOMBER append [[format["%1EA18G_209CAG", _sid],1]];
			...
			if(CTI_AIR_ADDON >= 2) then {
				AIR_BOMBER append [[format["%1EA18G_209LOW", _sid],1]];
		...
		if (isClass(configFile >> "CfgVehicles" >> "FIR_F35B_VMFA211")) then {
			if(CTI_AIR_ADDON >= 0) then {
				AIR_FIGHTER append [[format["%1FIR_F35B_VMFA211", _sid],1]];
			};
			if(CTI_AIR_ADDON >= 1) then {
				AIR_FIGHTER append [[format["%1FIR_F35B_VMFA214", _sid],1]];
				//_c pushBack format["%1FIR_F35B_DarkGrey", _sid];	
			};
			if(CTI_AIR_ADDON >= 2) then {
				AIR_FIGHTER append [[format["%1FIR_F35B_VMFA531", _sid],1]];
...
if(CTI_SOV_CUP_SIDE == _sideID || CTI_SOV_RHS_SIDE == _sideID) then {
	if(CTI_ECONOMY_LEVEL_AIR >= 3) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> "Mig29AWS_rus")) then {
			if(CTI_AIR_ADDON >= 0) then {
				AIR_FIGHTER append [[format["%1Mig29AWS_rus", _sid],1]];
			};
			if(CTI_AIR_ADDON >= 1) then {
				AIR_FIGHTER append [[format["%1Mig29AWS_SMT_rus", _sid],1]];
			};			
		};
		//The Sukhoi Su-33 Flanker-D									1994						Luftüberlegenheitsjäger
		if (isClass(configFile >> "CfgVehicles" >> "Su33_Protatype_PT_2")) then {
			AIR_FIGHTER append [[format["%1Su33_Protatype_PT_2", _sid],1]];
		};
	};
	if(CTI_ECONOMY_LEVEL_AIR >= 4) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> "AWS_SU34_genericopfor_BOMBER")) then {
			AIR_BOMBER append [[format["%1AWS_SU34_RU_BOMBER", _sid],1]];
		};
	};	
};
	...
	case west: {
		...
		if(CTI_ECONOMY_LEVEL_AIR >= 0) then {
			...
			if (isClass(configFile >> "CfgVehicles" >> "sab_panther_b")) then {
				AIR_BOMBER append [[format["%1sab_panther_b", _sid],1]];//Mai 1949					Jagdbomber	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_t28trojan_b")) then {
				AIR_FIGHTER append [[format["%1sab_t28trojan_b", _sid],1]];//1950						Trainingsflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_mystere_b")) then {
				AIR_BOMBER append [[format["%1sab_mystere_b", _sid],1]];//1954						Jagdbomber	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_fiat_b")) then {
				AIR_BOMBER append [[format["%1sab_fiat_b", _sid],1]];//August 1956				Erdkampf- und Aufklärungsflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_magister_b")) then {
				AIR_FIGHTER append [[format["%1sab_magister_b", _sid],1]];//1957						Strahltrainer	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_etendard_b")) then {
				AIR_FIGHTER append [[format["%1sab_etendard_b", _sid],1]];//Mai 1958					trägergestütztes Jagdflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_f104_b")) then {
				AIR_FIGHTER append [[format["%1sab_f104_b", _sid],1]];//Februar 1958				Abfangjäger	
			};
		};
		if(CTI_ECONOMY_LEVEL_AIR >= 1) then {
			if (isClass(configFile >> "CfgVehicles" >> "sab_mirageiv_b")) then {
				AIR_BOMBER append [[format["%1sab_mirageiv_b", _sid],1]];//Oktober 1964				Strategischer Bomber	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_sf260_b")) then {
				AIR_FIGHTER append [[format["%1sab_sf260_b", _sid],1]];//Juli 1964					Trainingsflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_pc7_b")) then {
				AIR_FIGHTER append [[format["%1sab_pc7_b", _sid],1]];//1978						Schulflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_alphajet_b")) then {
				AIR_BOMBER append [[format["%1sab_alphajet_b", _sid],1]];//1979						Leichter Jagdbomber	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_baehawk_b")) then {
				AIR_BOMBER append [[format["%1sab_baehawk_b", _sid],1]];//1974						Erdkampfflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_baehawk_b_2")) then {
				AIR_BOMBER append [[format["%1sab_baehawk_b_2", _sid],1]];//1974						Erdkampfflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_mb339_b")) then {
				AIR_BOMBER append [[format["%1sab_mb339_b", _sid],1]];//August 1979				Leichtes Erdkampfflugzeug	
			};
		};
		if(CTI_ECONOMY_LEVEL_AIR >= 2) then {
			if (isClass(configFile >> "CfgVehicles" >> "sab_m2000_b")) then {
				AIR_BOMBER append [[format["%1sab_m2000_b", _sid],1]];//Juni 1984					Mehrzweckkampfflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_pc9_b")) then {
				AIR_FIGHTER append [[format["%1sab_pc9_b", _sid],1]];//Mai 1984					Schulflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_t45goshawk_b")) then {
				AIR_FIGHTER append [[format["%1sab_t45goshawk_b", _sid],1]];//1991						Trainingsflugzeug	
			};
			
			//AV-8B Harrier 2												April 1969				VTOL-Erdkampfflugzeug
			if (isClass(configFile >> "CfgVehicles" >> "FIR_AV8B_Blank") && CTI_US_CUP_SIDE != _sideID && CTI_BAF_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_BOMBER append [[format["%1FIR_AV8B_Blank", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 1) then {
					AIR_BOMBER append [[format["%1FIR_AV8B_NA_Blank", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 2) then {
					AIR_BOMBER append [[format["%1FIR_AV8B_GR9A_Blank", _sid],1]];
				};
			};
			//F-14 Tomcat													//September 1974			Abfangjäger
			if (isClass(configFile >> "CfgVehicles" >> "FIR_F14A_Blank") && CTI_US_CUP_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_FIGHTER append [[format["%1FIR_F14A_Blank", _sid],1]];
					//_c pushBack format["%1FIR_F14B_Blank", _sid];	
					//_c pushBack format["%1FIR_F14D_Blank", _sid];	
				};
				if(CTI_AIR_ADDON >= 1) then {
					AIR_FIGHTER append [[format["%1FIR_F14D_AC6", _sid],1]];
				...
				if(CTI_AIR_ADDON >= 2) then {
					AIR_FIGHTER append [[format["%1FIR_F14A_VFA206", _sid],1]];
			...
			if (isClass(configFile >> "CfgVehicles" >> "FIR_F15C_Blank") && CTI_US_CUP_SIDE != _sideID) then {	
				...
				if(CTI_AIR_ADDON >= 2) then {
					//JPN
					AIR_FIGHTER append [[format["%1FIR_F15DJ_202TFS", _sid],1]];
			...
			if (isClass(configFile >> "CfgVehicles" >> "FIR_A10A_Blank") && CTI_US_CUP_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_BOMBER append [[format["%1FIR_A10A_Blank", _sid],1]];	//white
					//_c pushBack format["%1FIR_A10C_Blank", _sid];	
				};
				if(CTI_AIR_ADDON >= 1) then {	
					AIR_BOMBER append [[format["%1FIR_A10A_Blank2", _sid],1]];	//camo
			...
			if (isClass(configFile >> "CfgVehicles" >> "FIR_F16D_Blank") && CTI_US_CUP_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {	
					AIR_FIGHTER append [[format["%1FIR_F16C_Blank", _sid],1]];
					//_c pushBack format["%1FIR_F16D_Blank", _sid];	
				};
				if(CTI_AIR_ADDON >= 1) then {
					AIR_FIGHTER append [[format["%1FIR_F16C_MERC", _sid],1]];
				...
				if(CTI_AIR_ADDON >= 2) then {
					//Polish
					AIR_FIGHTER append [[format["%1FIR_F16C_Polish", _sid],1]];
		...
		if(CTI_ECONOMY_LEVEL_AIR >= 3) then {
			...
			if (isClass(configFile >> "CfgVehicles" >> "Tornado_AWS_1") && CTI_BAF_SIDE != _sideID && CTI_BW_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {
					//default
					AIR_BOMBER append [[format["%1Tornado_AWS_1", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 1) then {
					AIR_BOMBER append [[format["%1Tornado_AWS_50_DS", _sid],1]];
				};	
				if(CTI_AIR_ADDON >= 2) then {
					AIR_BOMBER append [[format["%1Tornado_AWS_camo_ita", _sid],1]];
			...
			if (isClass(configFile >> "CfgVehicles" >> "Mig29AWS_blufor")) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_FIGHTER append [[format["%1Mig29AWS_blufor", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 1) then {
					AIR_FIGHTER append [[format["%1Mig29AWS_chern", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 2) then {
					AIR_FIGHTER append [[format["%1Mig29AWS_livonia", _sid],1]];
				};			
			};
			//F/A-18 Hornet												7. Januar 1983				Mehrzweckkampfflugzeug
			if (isClass(configFile >> "CfgVehicles" >> "FIR_F18C_Blank") && CTI_US_CUP_SIDE != _sideID && CTI_BAF_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_FIGHTER append [[format["%1FIR_F18C_Blank", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 1) then {
					AIR_FIGHTER append [[format["%1FIR_F18C_Scar", _sid],1]];
					//_c pushBack format["%1FIR_F18C_Blank_Aggressor", _sid];	
				};
				if(CTI_AIR_ADDON >= 2) then {
					AIR_FIGHTER append [[format["%1FIR_F18C_FINNISH", _sid],1]];
			...
			if (isClass(configFile >> "CfgVehicles" >> "JS_JC_FA18E")) then {
				AIR_FIGHTER append [[format["%1JS_JC_FA18E", _sid],1]];
				AIR_FIGHTER append [[format["%1JS_JC_FA18F", _sid],1]];
			};
		};
		if(CTI_ECONOMY_LEVEL_AIR >= 4) then {
			...
			if (isClass(configFile >> "CfgVehicles" >> "FIR_F2A_Blank") && CTI_US_CUP_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_FIGHTER append [[format["%1FIR_F2A_Blank", _sid],1]];
					//_c pushBack format["%1FIR_F2B_Blank", _sid];
				};
				if(CTI_AIR_ADDON >= 1) then {
					AIR_FIGHTER append [[format["%1FIR_F2A_60Ani", _sid],1]];//1 seat JPN	
					//_c pushBack format["%1FIR_F2B_21sq", _sid];//2 seats
				};	
				if(CTI_AIR_ADDON >= 2) then {
					AIR_FIGHTER append [[format["%1FIR_F2A_TACMEET", _sid],1]];	
			...
			if (isClass(configFile >> "CfgVehicles" >> "sab_pc21_b")) then {
				AIR_BOMBER append [[format["%1sab_pc21_b", _sid],1]];
			};
			//F-22 Raptor													15. Dezember 2005			Luftüberlegenheitsjäger
			if (isClass(configFile >> "CfgVehicles" >> "FIR_F22_Blank") && CTI_US_CUP_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_FIGHTER append [[format["%1FIR_F22_Blank", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 1) then {
					AIR_FIGHTER append [[format["%1FIR_F22_Blank2", _sid],1]];
					//_c pushBack format["%1FIR_F22_Blank3", _sid];
				};
				if(CTI_AIR_ADDON >= 2) then {
					AIR_FIGHTER append [[format["%1FIR_F22_Gryphus1", _sid],1]];//unknown icon	
			...
			if (isClass(configFile >> "CfgVehicles" >> "EAWS_EF2000_Genericblu_CAP") && CTI_BAF_SIDE != _sideID && CTI_BW_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_FIGHTER append [[format["%1EAWS_EF2000_genericartic2_CAP", _sid],1]];
					//_c pushBack format["%1EAWS_EF2000_genericgray2_CAP", _sid];	
				};					
				if(CTI_AIR_ADDON >= 1) then {	
					AIR_FIGHTER append [[format["%1EAWS_EF2000_genericdesert2_CAP", _sid],1]];
					//_c pushBack format["%1EAWS_EF2000_Genericblu_CAP", _sid];
				};				
				if(CTI_AIR_ADDON >= 2) then {
					AIR_FIGHTER append [[format["%1EAWS_EF2000_FRA_CAP", _sid],1]];
			...
			if (isClass(configFile >> "CfgVehicles" >> "FIR_EA18G_Blank") && CTI_US_CUP_SIDE != _sideID && CTI_BAF_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_BOMBER append [[format["%1FIR_EA18G_Blank", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 1) then {
					AIR_BOMBER append [[format["%1FIR_EA18G_NA", _sid],1]];
				};	
			};
			//SU-34SM FULLBACK-D AWS										9. Dezember 2011				Jagdbomber
			if (isClass(configFile >> "CfgVehicles" >> "AWS_SU34_CDF_BOMBER")) then {
				AIR_BOMBER append [[format["%1AWS_SU34_CDF_BOMBER", _sid],1]];
			};
			//Project Lightning - F-35B Armaverse Version					31. Juli 2015				Mehrzweckkampfflugzeug
			if (isClass(configFile >> "CfgVehicles" >> "FIR_F35B_Blank1") && CTI_US_CUP_SIDE != _sideID && CTI_BAF_SIDE != _sideID && CTI_BW_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_FIGHTER append [[format["%1FIR_F35B_Blank1", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 1) then {
					AIR_FIGHTER append [[format["%1FIR_F35B_Blank2", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 2) then {
					AIR_FIGHTER append [[format["%1FIR_F35B_Arctic", _sid],1]];
				};		
			};
		};
	};
	case east: {
		...
		if(CTI_ECONOMY_LEVEL_AIR >= 0) then {
			...
			if (isClass(configFile >> "CfgVehicles" >> "sab_panther_o")) then {
				AIR_BOMBER append [[format["%1sab_panther_o", _sid],1]];//Mai 1949					Jagdbomber
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_t28trojan_o")) then {
				AIR_FIGHTER append [[format["%1sab_t28trojan_o", _sid],1]];//1950						Trainingsflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_mystere_o")) then {
				AIR_BOMBER append [[format["%1sab_mystere_o", _sid],1]];//1954						Jagdbomber	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_fiat_o")) then {
				AIR_BOMBER append [[format["%1sab_fiat_o", _sid],1]];//August 1956				Erdkampf- und Aufklärungsflugzeug
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_magister_o")) then {
				AIR_FIGHTER append [[format["%1sab_magister_o", _sid],1]];//1957						Strahltrainer	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_etendard_o")) then {
				AIR_FIGHTER append [[format["%1sab_etendard_o", _sid],1]];//Mai 1958					trägergestütztes Jagdflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_f104_o")) then {
				AIR_FIGHTER append [[format["%1sab_f104_o", _sid],1]];//Februar 1958				Abfangjäger	
			};
		};
		if(CTI_ECONOMY_LEVEL_AIR >= 1) then {
			if (isClass(configFile >> "CfgVehicles" >> "sab_mirageiv_o")) then {
				AIR_BOMBER append [[format["%1sab_mirageiv_o", _sid],1]];//Oktober 1964				Strategischer Bomber	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_sf260_o")) then {
				AIR_FIGHTER append [[format["%1sab_sf260_o", _sid],1]];//Juli 1964					Trainingsflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_pc7_o")) then {
				AIR_FIGHTER append [[format["%1sab_pc7_o", _sid],1]];//1978						Schulflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_alphajet_o")) then {
				AIR_BOMBER append [[format["%1sab_alphajet_o", _sid],1]];//1979						Leichter Jagdbomber	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_baehawk_o")) then {
				AIR_BOMBER append [[format["%1sab_baehawk_o", _sid],1]];//1974						Erdkampfflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_mb339_o")) then {
				AIR_BOMBER append [[format["%1sab_mb339_o", _sid],1]];//August 1979				Leichtes Erdkampfflugzeug	
			};
		};
		
		if(CTI_ECONOMY_LEVEL_AIR >= 2) then {
			if (isClass(configFile >> "CfgVehicles" >> "sab_m2000_o")) then {
				AIR_BOMBER append [[format["%1sab_m2000_o", _sid],1]];//Juni 1984					Mehrzweckkampfflugzeug	
			};
			if (isClass(configFile >> "CfgVehicles" >> "sab_pc9_o")) then {
					AIR_FIGHTER append [[format["%1sab_pc9_o", _sid],1]];//Mai 1984					Schulflugzeug	
			};
			//F-14 Tomcat													September 1974			Abfangjäger
			if (isClass(configFile >> "CfgVehicles" >> "FIR_F14D_ENEMY_TYPE_A")) then {
				AIR_BOMBER append [[format["%1FIR_F14D_ENEMY_TYPE_A", _sid],1]];
			};
			//A-10 Warthog												März 1977					Erdkampfflugzeug
			if (isClass(configFile >> "CfgVehicles" >> "FIR_A10C_Enemy_Type1")) then {
				AIR_BOMBER append [[format["%1FIR_A10C_Enemy_Type1", _sid],1]];
			};
		};
		...
		if(CTI_ECONOMY_LEVEL_AIR >= 3) then {
			...
			if (isClass(configFile >> "CfgVehicles" >> "Tornado_AWS_opf")) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_BOMBER append [[format["%1Tornado_AWS_opf", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 1) then {
					AIR_BOMBER append [[format["%1Tornado_AWS_ADV_OPF", _sid],1]];
			...
			if (isClass(configFile >> "CfgVehicles" >> "Mig29AWS_rus") && CTI_SOV_CUP_SIDE != _sideID && CTI_SOV_RHS_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {	
					AIR_FIGHTER append [[format["%1Mig29AWS_sla", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 1) then {
					AIR_FIGHTER append [[format["%1Mig29AWS_taki", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 2) then {
					AIR_FIGHTER append [[format["%1Mig29AWS_chernreb", _sid],1]];
				};	
			};
			//F/A-18 Hornet												7. Januar 1983			Mehrzweckkampfflugzeug
			if (isClass(configFile >> "CfgVehicles" >> "FIR_F18C_Enemy_Type1")) then {
					AIR_FIGHTER append [[format["%1FIR_F18C_Enemy_Type1", _sid],1]];
			};
			//The Sukhoi Su-33 Flanker-D									1994						Luftüberlegenheitsjäger
			if (isClass(configFile >> "CfgVehicles" >> "Su33_Protatype_PT_2") && CTI_SOV_CUP_SIDE != _sideID && CTI_SOV_RHS_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_FIGHTER append [[format["%1Su33_Chine", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 2) then {
					AIR_FIGHTER append [[format["%1Su33_Chine_PT", _sid],1]];	
				};		
			};
		};
		if(CTI_ECONOMY_LEVEL_AIR >= 4) then {
			if (isClass(configFile >> "CfgVehicles" >> "sab_pc21_o")) then {
				AIR_FIGHTER append [[format["%1sab_pc21_o", _sid],1]];//Juli 2002					Schulflugzeug
			};
			//F-22 Raptor													15. Dezember 2005			Luftüberlegenheitsjäger
			if (isClass(configFile >> "CfgVehicles" >> "FIR_F22_ENEMY_TYPE_A")) then {
				AIR_FIGHTER append [[format["%1FIR_F22_ENEMY_TYPE_A", _sid],1]];
			};
			//Eurofighter Typhoon AWS										Juli 2006					Mehrzweckkampfflugzeug
			if (isClass(configFile >> "CfgVehicles" >> "EAWS_EF2000_Genericopfor_CAP")) then {
				if(CTI_AIR_ADDON >= 0) then {	
					AIR_FIGHTER append [[format["%1EAWS_EF2000_Genericopfor_CAP", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 1) then {	
					AIR_FIGHTER append [[format["%1EAWS_EF2000_taki_CAP", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 2) then {
					AIR_FIGHTER append [[format["%1EAWS_EF2000_genericartic_CAP", _sid],1]];
			...
			if (isClass(configFile >> "CfgVehicles" >> "JS_JC_SU35")) then {
				AIR_FIGHTER append [[format["%1JS_JC_SU35", _sid],1]];//CSAT camo	
			};			
			//Sukhoi Su-34													9. Dezember 2011				Jagdbomber
			if (isClass(configFile >> "CfgVehicles" >> "sab_su34_O")) then {
				AIR_BOMBER append [[format["%1sab_su34_O", _sid],1]];
			};
			//SU-34SM FULLBACK-D AWS										9. Dezember 2011				Jagdbomber
			if (isClass(configFile >> "CfgVehicles" >> "AWS_SU34_genericopfor_BOMBER") && CTI_SOV_CUP_SIDE != _sideID && CTI_SOV_RHS_SIDE != _sideID) then {
				if(CTI_AIR_ADDON >= 0) then {
					AIR_BOMBER append [[format["%1AWS_SU34_genericopfor_BOMBER", _sid],1]];	
				};
				if(CTI_AIR_ADDON >= 1) then {	
					AIR_BOMBER append [[format["%1AWS_SU34_plaaf_BOMBER", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 2) then {
					AIR_BOMBER append [[format["%1AWS_SU34_sla_BOMBER", _sid],1]];	
	...
	default {
		if(CTI_ECONOMY_LEVEL_AIR >= 3) then {
			...
			if (isClass(configFile >> "CfgVehicles" >> "Tornado_AWS_ind")) then {
				AIR_BOMBER append [[format["%1Tornado_AWS_ind", _sid],1]];
				AIR_BOMBER append [[format["%1Tornado_AWS_ADV_IND", _sid],1]];
			};
		};
		...
		if(CTI_ECONOMY_LEVEL_AIR >= 4) then {
			...
			if (isClass(configFile >> "CfgVehicles" >> "EAWS_EF2000_Genericind_CAP")) then {
				if(CTI_AIR_ADDON >= 0) then {	
					AIR_FIGHTER append [[format["%1EAWS_EF2000_racs_CAP", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 1) then {	
					AIR_FIGHTER append [[format["%1EAWS_EF2000_Genericind_CAP", _sid],1]];
				};
				if(CTI_AIR_ADDON >= 2) then {	
					AIR_FIGHTER append [[format["%1EAWS_EF2000_genericdesert3_CAP", _sid],1]];
...
if (CTI_Log_Level >= CTI_Log_Debug) then {
	["VIOC_DEBUG", "FILE: common\config\Towns_other_mods.sqf", format["Town Squad <%1> with units <%2> ", format["%1AIR_SQ_FIGHTER", _tag], missionNamespace getVariable format["%1AIR_SQ_FIGHTER", _tag]]] call CTI_CO_FNC_Log;
	["VIOC_DEBUG", "FILE: common\config\Towns_other_mods.sqf", format["Town Squad <%1> with units <%2> ", format["%1AIR_SQ_BOMBER", _tag], missionNamespace getVariable format["%1AIR_SQ_BOMBER", _tag]]] call CTI_CO_FNC_Log;
};
...
if (CTI_Log_Level >= CTI_Log_Debug) then {
	["VIOC_DEBUG", "FILE: common\config\Towns_other_mods.sqf", format["Town Squad <%1> with units <%2> ", format["%1SQ_ANTI_AIR", _tag], missionNamespace getVariable format["%1SQ_ANTI_AIR", _tag]]] call CTI_CO_FNC_Log;
};
*/
