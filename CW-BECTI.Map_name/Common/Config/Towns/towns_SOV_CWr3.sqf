...
if(_tag == "GUER_") then {
	switch(CTI_TOWN_CAMO) do {
		...
		case 4: {//desert/urban camo active
			...
			missionNamespace setVariable [format["CTI_%1Crew", _tag], format["%1cwr3_o_soldier82_driver", _sid]];
		...
		default {//main camo active
			...
			missionNamespace setVariable [format["CTI_%1Crew", _tag], format["%1cwr3_o_soldier", _sid]];
			missionNamespace setVariable [format["CTI_%1Pilot", _tag], format["%1cwr3_o_camel_pilot", _sid]];
		};	
	};
};
...
if !(CTI_TOWN_CAMO == CTI_CAMO_ACTIVATION) then {
	missionNamespace setVariable [format["CTI_%1TownLeader", _tag], format["%1cwr3_o_soldier82_sl", _sid]];
	missionNamespace setVariable [format["CTI_%1TownSoldier", _tag], format["%1cwr3_o_soldier82", _sid]];
	missionNamespace setVariable [format["CTI_%1TownCrew", _tag], format["%1cwr3_o_soldier82", _sid]];
};
