...
if (_setupBaseUnits) then {
	switch(CTI_CAMO_ACTIVATION) do {
		...
		case 2: {//desert camo active
			missionNamespace setVariable [format["CTI_%1_Commander", _side], format["%1BWA3_TL_Tropen", _sid]];
			missionNamespace setVariable [format["CTI_%1_Worker", _side], format["%1BWA3_Rifleman_unarmed_Tropen", _sid]];

			missionNamespace setVariable [format["CTI_%1_Diver", _side], format["%1BWA3_Rifleman_Tropen", _sid]];
			missionNamespace setVariable [format["CTI_%1_Soldier", _side], format["%1BWA3_Rifleman_Tropen", _sid]];
			missionNamespace setVariable [format["CTI_%1_Crew", _side], format["%1BWA3_Crew_Tropen", _sid]];
			missionNamespace setVariable [format["CTI_%1_Static", _side], format["%1BWA3_Crew_Tropen", _sid]];
		};
		case 3: {//jungle camo active
			missionNamespace setVariable [format["CTI_%1_Commander", _side], format["%1BWA3_TL_Fleck", _sid]];
			missionNamespace setVariable [format["CTI_%1_Worker", _side], format["%1BWA3_Rifleman_unarmed_Fleck", _sid]];

			missionNamespace setVariable [format["CTI_%1_Diver", _side], format["%1BWA3_Rifleman_Fleck", _sid]];
			...
			missionNamespace setVariable [format["CTI_%1_Static", _side], format["%1BWA3_Crew_Fleck", _sid]];
		};
		default {//main camo active
			missionNamespace setVariable [format["CTI_%1_Commander", _side], format["%1BWA3_TL_Multi", _sid]];
			missionNamespace setVariable [format["CTI_%1_Worker", _side], format["%1BWA3_Rifleman_unarmed_Multi", _sid]];

			missionNamespace setVariable [format["CTI_%1_Diver", _side], format["%1BWA3_Rifleman_Multi", _sid]];
			missionNamespace setVariable [format["CTI_%1_Soldier", _side], format["%1BWA3_Rifleman_Multi", _sid]];
			missionNamespace setVariable [format["CTI_%1_Crew", _side], format["%1BWA3_Crew_Multi", _sid]];
			missionNamespace setVariable [format["CTI_%1_Static", _side], format["%1BWA3_Crew_Multi", _sid]];
		};	
	};
	...
	if (CTI_Log_Level >= CTI_Log_Debug) then {
		["VIOC_DEBUG", "FILE: common\config\factories\factory_BW_BWA3.sqf", format["Commander: <%1>", missionNamespace getVariable format["CTI_%1_Commander", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_BW_BWA3.sqf", format["Worker: <%1>", missionNamespace getVariable format["CTI_%1_Worker", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_BW_BWA3.sqf", format["Diver: <%1>", missionNamespace getVariable format["CTI_%1_Diver", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_BW_BWA3.sqf", format["Soldier: <%1>", missionNamespace getVariable format["CTI_%1_Soldier", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_BW_BWA3.sqf", format["Crew: <%1>", missionNamespace getVariable format["CTI_%1_Crew", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_BW_BWA3.sqf", format["Pilot: <%1>", missionNamespace getVariable format["CTI_%1_Pilot", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_BW_BWA3.sqf", format["Static: <%1>", missionNamespace getVariable format["CTI_%1_Static", _side]]] call CTI_CO_FNC_Log;
	};
};
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\factories\factory_BW_BWA3.sqf", format["starting vehicles for side %1 declared", _side]] call CTI_CO_FNC_Log;};
