...
if ((CTI_CWR3_ADDON > 1 || _ai == CTI_US_ID) || (CTI_CUP_ADDON > 0 && CTI_CWR3_ADDON > 0) || (CTI_CUP_ADDON < 1 && CTI_CWR3_ADDON > 0)) then {
	...
	missionNamespace setVariable [format["CTI_%1_Soldier", _side], format["%1cwr3_b_soldier82", _sid]];
	missionNamespace setVariable [format["CTI_%1_Crew", _side], format["%1cwr3_b_soldier82_driver", _sid]];
	missionNamespace setVariable [format["CTI_%1_Pilot", _side], format["%1cwr3_b_camel_pilot", _sid]];
	missionNamespace setVariable [format["CTI_%1_Static", _side], format["%1cwr3_b_soldier82_driver", _sid]];
	...
	if (CTI_Log_Level >= CTI_Log_Debug) then {
		["VIOC_DEBUG", "FILE: common\config\factories\factory_US_CWr3.sqf", format["Commander: <%1>", missionNamespace getVariable format["CTI_%1_Commander", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_US_CWr3.sqf", format["Worker: <%1>", missionNamespace getVariable format["CTI_%1_Worker", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_US_CWr3.sqf", format["Diver: <%1>", missionNamespace getVariable format["CTI_%1_Diver", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_US_CWr3.sqf", format["Soldier: <%1>", missionNamespace getVariable format["CTI_%1_Soldier", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_US_CWr3.sqf", format["Crew: <%1>", missionNamespace getVariable format["CTI_%1_Crew", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_US_CWr3.sqf", format["Pilot: <%1>", missionNamespace getVariable format["CTI_%1_Pilot", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_US_CWr3.sqf", format["Static: <%1>", missionNamespace getVariable format["CTI_%1_Static", _side]]] call CTI_CO_FNC_Log;
	};
};
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\factories\factory_US_CWr3.sqf", format["starting vehicles for side %1 declared", _side]] call CTI_CO_FNC_Log;};
