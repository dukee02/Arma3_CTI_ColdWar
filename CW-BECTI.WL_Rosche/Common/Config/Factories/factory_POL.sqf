...
//											Setup base units																				  *
//*********************************************************************************************************************************************
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["setting up factory units for side %1", _side]] call CTI_CO_FNC_Log;};
...
if (isNil "_priorUnits" || _ai == 2) then { 
	...
	if(CTI_MAIN_ADDON == 0) then {
		missionNamespace setVariable [format["CTI_%1_Commander", _side], format["%1gm_pl_army_squadleader_akm_80_moro", _sid]];
		missionNamespace setVariable [format["CTI_%1_Worker", _side], format["%1gm_pl_army_demolition_akm_80_moro", _sid]];

		missionNamespace setVariable [format["CTI_%1_Diver", _side], format["%1gm_pl_army_rifleman_akm_80_moro", _sid]];
		missionNamespace setVariable [format["CTI_%1_Soldier", _side], format["%1gm_pl_army_rifleman_akm_80_moro", _sid]];
		missionNamespace setVariable [format["CTI_%1_Crew", _side], format["%1gm_pl_army_crew_pm_80_moro", _sid]];
		missionNamespace setVariable [format["CTI_%1_Pilot", _side], format["%1gm_pl_airforce_pilot_pm_80_gry", _sid]];
		missionNamespace setVariable [format["CTI_%1_Static", _side], format["%1gm_pl_army_crew_pm_80_moro", _sid]];

		//Set starting vehicles
		missionNamespace setVariable [format["CTI_%1_Vehicles_Startup", _side], [ 
			[format["%1gm_gc_civ_p601", _sid], []], 
			[format["%1gm_gc_civ_p601", _sid], []]
		]];
	};
	if (CTI_Log_Level >= CTI_Log_Debug) then {
		["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["Commander: <%1>", missionNamespace getVariable format["CTI_%1_Commander", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["Worker: <%1>", missionNamespace getVariable format["CTI_%1_Worker", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["Diver: <%1>", missionNamespace getVariable format["CTI_%1_Diver", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["Soldier: <%1>", missionNamespace getVariable format["CTI_%1_Soldier", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["Crew: <%1>", missionNamespace getVariable format["CTI_%1_Crew", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["Pilot: <%1>", missionNamespace getVariable format["CTI_%1_Pilot", _side]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["Static: <%1>", missionNamespace getVariable format["CTI_%1_Static", _side]]] call CTI_CO_FNC_Log;
	};
};
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["starting vehicles for side %1 declared", _side]] call CTI_CO_FNC_Log;};
...
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["units in factory %1: [%2] ", CTI_BARRACKS, count _c]] call CTI_CO_FNC_Log;};
...
if(CTI_MAIN_ADDON == 0) then {
	...
	if(CTI_ECONOMY_LEVEL_WHEELED >= 1+_adds) then {
		_c pushBack format["%1gm_pl_army_ural375d_medic", _sid];		//Medic
...
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["units in factory %1: [%2] ", CTI_LIGHT, count _c]] call CTI_CO_FNC_Log;};
...
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["units in factory %1: [%2] ", CTI_HEAVY, count _c]] call CTI_CO_FNC_Log;};
...
if(CTI_MAIN_ADDON == 0) then {
	...
	if(CTI_ECONOMY_LEVEL_AIR >= 1) then {
		_c pushBack format["%1gm_pl_airforce_mi2sr", _sid];
...
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["units in factory %1: [%2] ", CTI_AIR, count _c]] call CTI_CO_FNC_Log;};
...
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["units in factory %1: [%2] ", CTI_REPAIR, count _c]] call CTI_CO_FNC_Log;};
...
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["units in factory %1: [%2] ", CTI_AMMO, count _c]] call CTI_CO_FNC_Log;};
...
if(CTI_MAIN_ADDON == 0) then {
	...
	if ((missionNamespace getVariable "CTI_UNITS_TOWN_PURCHASE") > 0) then {
		if(CTI_ECONOMY_LEVEL_WHEELED >= 0) then {
			_c pushBack format["%1gm_pl_army_ural4320_repair", _sid];				//repairtruck
			_c pushBack format["%1gm_pl_army_ural4320_reammo", _sid];				//ammotruck
			_c pushBack format["%1gm_pl_army_ural375d_refuel", _sid];	
		};
	};
};
...
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["units in factory %1: [%2] ", CTI_DEPOT, count _c]] call CTI_CO_FNC_Log;};
...
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\factories\factory_POL.sqf", format["units in factory %1: [%2] ", CTI_NAVAL, count _c]] call CTI_CO_FNC_Log;};
