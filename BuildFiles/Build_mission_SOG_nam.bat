@echo off
title VIO-BECTI-CW.Cam_Lao_Nam Mission gets created
...
copy "%gitpath%\CW-BECTI.Map_name\RSC\Parameters_SOG.hpp" "%buildpath%\%missionfloder%\RSC\Parameters.hpp"
