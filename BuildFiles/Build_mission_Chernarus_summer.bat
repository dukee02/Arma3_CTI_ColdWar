@echo off
title VIO-BECTI-CW.Chernarus_summer Mission gets created
...
copy "%gitpath%\CW-BECTI.Map_name\RSC\Parameters_chernarus.hpp" "%buildpath%\%missionfloder%\RSC\Parameters.hpp"
