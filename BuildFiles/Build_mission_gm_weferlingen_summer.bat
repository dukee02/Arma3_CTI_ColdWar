...
set mapname="gm_weferlingen_summer"
...
copy "%gitpath%\CW-BECTI.Map_name\RSC\Parameters_weferlingen.hpp" "%buildpath%\%missionfloder%\RSC\Parameters.hpp"
...
copy "%gitpath%\CW-BECTI.Map_name\mission_weferlingen.sqm" "%buildpath%\%missionfloder%\mission.sqm"
::copy "%gitpath%\CW-BECTI.Map_name\VIO_BECTI.jpg" "%buildpath%\%missionfloder%\VIO_BECTI.jpg"
copy "%gitpath%\CW-Thumpnails\CW_BECTI_weferlingen_small.jpg" "%buildpath%\%missionfloder%\VIO_BECTI.jpg"
